	...
	<section class="content-header">
	    <div class="row">
	        <div class="col-md-12" style="color:#555;margin-bottom:-20px;">
	            <ul class="breadcrumb">
	                <li><a href="" style="color:#555;">Receitas</a></li>
	                <li><a href="" style="color:#555;">Cobrança Parcelada (boletos a receber)</a></li>
	            </ul>
	        </div>
	    </div>
	</section>
	...
	<section class="content">
	    <div class="alert alert-info alert-dismissible" style="background-color:#2e4158 !important;border-color:white">
	        ...
	        <p class="text-capitalize" style="font-size:14px">Nesta Tela Você Pode Acompanhar Receitas que você ira receber
	            em parcelas</p>
	    </div>
	            ...
	            <div class="row">
	                <div class="col-md-4">
	                    <button class="btn btn-app bg-default btn-touch" data-toggle="modal"
	                        data-target="#modal-default"><i class="fa fa-plus-square"></i> Nova Receita
	                        Recorrente
	                    </button>
	                </div>
	            </div>
	        ...
	        <div class="box-body">
	            <table class="table table-bordered table-striped dt-responsive tabela-res" width="100%">
	                ...
	                <tbody>
                      ...
                      $data_atual = $data;
                      echo "<button class='btn bg-olive fundov btn-xs' style='margin-left:3px'>".
	                    ...
	                    <div class="row">
	                        ...
	                        <div class="form-group col-md-4">
	                            ...
	                            <div class="input-group">
	                                ...
	                                <input type="text" class="form-control pull-right" name="ventrada" value="0.00"
	                                    id="valorenrec" placeholder="0.00">
	                            </div>
	                        </div>
	                        ...
	                        <div class="form-group col-md-4">
	                            ...
	                            <div class="input-group">
	                                ...
	                                <input type="text" class="form-control pull-right" name="juro" value="0.0" id="jurorec"
	                                    placeholder="0.0">
	                            </div>
	                        </div>
	                    </div>
