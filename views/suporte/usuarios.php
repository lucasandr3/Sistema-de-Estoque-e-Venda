              ...
              <table class="table table-bordered table-striped dt-responsive tabela-res" width="100%">
                  ...
                  <tbody>
                      ...
                      <tr>
                          ...
                          <td class="text-capitalize"><?php echo $item['func'] ?></td>
                          <!-- <td>
                              <a href="<?=BASE_URL?>vendedores/edit/<?=$item['id']?>" class="btn btn-primary btn-xs"><i
                                      class="fa fa-pencil"></i> Editar</a>
                              <a href="<?=BASE_URL?>permissions" class="btn btn-success btn-xs">Permissões
                              </a>
                          </td> -->
                      </tr>
                      <?php endforeach ?>
