              ...
              <?php $pagamento = explode(',', $venda['pay']) ?>
                  ...
                  <div class="row" style="margin-bottom:20px;">
                      <div class="col-md-6">
                          ...
                          <input type="text" class="form-control" value="<?=($venda['f_cartao_c2_loja_hist'] === '')?'0.00':$venda['f_cartao_c2_loja_hist']?>" name="f_cartao_c2" />
                          <?php if($venda['f_cartao_c2_loja_hist'] !== '0.00'): ?>
                            <input type="hidden" class="form-control" name="pagamento[]" value="2º Cartão de Crédito (Loja)" placeholder="0,00">
                          <?php endif; ?>  
                      </div>
                      <div class="col-md-6">
                          <label>Parcelas e Taxa</label>
                          <select class="form-control select2" name="tc2loja">
                              <option value="0">Escolha uma Taxa</option>
                              <?php foreach($taxas_credito_loja as $tc): ?>
                                <optgroup label="<?=$tc['brand']?>">
                                    <?php foreach($tc['tax'] as $taxs): ?>
                  ...
                  <div class="row" style="margin-bottom:20px;">
                      <div class="col-md-6">
                          ...
                          <input type="text" class="form-control" value="<?=($venda['f_cartao_d2_loja_hist'] === '')?'0.00':$venda['f_cartao_d2_loja_hist']?>" name="f_cartao_d2" />
                          <?php if($venda['f_cartao_d2_loja_hist'] !== '0.00'): ?>
                            <input type="hidden" class="form-control" name="pagamento[]" value="2º Cartão de Débito (Loja)" placeholder="0,00">
                          <?php endif; ?>  
                      </div>
                      <div class="col-md-6">
                          <label>Parcelas e Taxa</label>
                          <select class="form-control select2" name="td2loja">
                              <option value="0">Escolha uma Taxa</option>
                              <?php foreach($taxas_debito_loja as $tc): ?>
                                <optgroup label="<?=$tc['brand']?>">
                                    <?php foreach($tc['tax'] as $taxs): ?>
                  ...
                  <div class="row" style="margin-bottom:20px;">
                      <div class="col-md-6">
                          ...
                          <input type="text" class="form-control" value="<?=$venda['f_cartao_c2_parc_hist']?>" name="f_cartao_c2_parc" />
                          <?php if($venda['f_cartao_c2_parc_hist'] !== '0.00'): ?>
                            <input type="hidden" class="form-control" name="pagamento[]" value="<?=($venda['f_cartao_c2_parc_hist'] === '0.00')?'':'2º Cartão de Crédito (Fornecedor)'?>" placeholder="0,00">
                          <?php endif; ?>
                      </div>
                  </div>
                  ...
                  <div class="row">
                      <div class="col-md-6">
                          <label>2º Cartão de Débito (Fornecedor)</label>
                          <input type="text" class="form-control" style="margin-bottom:15px;" value="<?=($venda['f_cartao_d2_parc_hist'] === '0.00')?$venda['f_cartao_d2_parc_hist']:'0.00'?>" name="f_cartao_d2_parc" />
                          <?php if($venda['f_cartao_d2_parc_hist'] !== '0.00'): ?>
                            <input type="hidden" class="form-control" name="pagamento[]" value="<?=($venda['f_cartao_d2_parc_hist'] === '0.00')?'':'2º Cartão de Débito (Fornecedor)'?>" placeholder="0,00">
                          <?php endif; ?>
                      </div> 
                  </div>
