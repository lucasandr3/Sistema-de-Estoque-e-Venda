              ...
              <?php $pagamento = explode(',', $venda['pay']) ?>
                  ...
                  <div class="row" style="margin-bottom:20px;">
                      <div class="col-md-4">
                          ...
                          <input type="text" class="form-control" name="f_dinheiro" value="<?=$venda['f_dinheiro']?>" placeholder="0,00">
                      </div>
                  </div>
                  ...
                  <div class="row" style="margin-bottom:20px;">
                      <div class="col-md-6">
                          ...
                          <select class="form-control select2" name="f_cartao_c">
                              <option value="<?=$venda['f_cartao_c_loja_hist']?>"><?=$venda['f_cartao_c_loja_hist']?></option>
                          </select>
                      </div>
                      <div class="col-md-6">
                  ...
                  <div class="row" style="margin-bottom:20px;">
                      <div class="col-md-6">
                          ...
                          <select class="form-control select2" name="f_cartao_d">
                              <option value="<?=$venda['f_cartao_d_loja_hist']?>"><?=$venda['f_cartao_d_loja_hist']?></option>
                              <?php foreach($parceiros as $parceiro): ?>
                  ...
                  <div class="row" style="margin-bottom:20px;">
                      <div class="col-md-6">
                          ...
                          <select class="form-control select2" name="f_cartao_c_parc">
                            <option value="<?=$venda['f_cartao_c_parc_hist']?>"><?=$venda['f_cartao_c_parc_hist']?></option>
                          </select>
                      </div>
                      <div class="col-md-6">
                          <label>Parcelas e Taxa</label>
                  ...
                  <div class="row">
                      <div class="col-md-6">
                          ...
                          <select class="form-control select2" name="f_cartao_d_parc">
                            <option value="<?=$venda['f_cartao_d_parc_hist']?>"><?=$venda['f_cartao_d_parc_hist']?></option>
                          </select>
                      </div>
                      <div class="col-md-6">
                          <label>Parcelas e Taxa</label>
                    ...
                    <div class="row" style="margin-bottom:20px;">
                        <div class="col-md-6">
                            <label>Pix</label>
                            <input type="text" class="form-control" name="f_pix" value="<?=$venda['f_pix']?>" placeholder="0,00">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label>Pic Pay</label>
                            <select class="form-control select2" name="f_pic_pay">
                                <option value="<?=$venda['f_picpay_hist']?>"><?=$venda['f_picpay_hist']?></option>
                        ...
                        <div class="col-md-6">
                            ...
                            <?php foreach($taxas_picpay as $tc): ?>
                                <optgroup label="<?=$tc['brand']?>">
                                    <?php foreach($tc['tax'] as $taxs): ?>
                                        <option value="<?=$taxs['taxa_v']?>-<?=$venda['f_pic_pay']?>">Taxa <?=$taxs['taxa_v']?> - <?=$tc['brand']?></option>
                                    <?php endforeach; ?>
                                </optgroup>
                            <?php endforeach; ?>
                          </select>
