...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-12">
                    <button class="btn btn-app bg-default" data-toggle="modal"
                        data-target="#modal-calculadora"><i class="fa fa-calculator"></i> Calcular imposto
                    </button>
    ...
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title"><i class="fa fa-warning"></i> <b>Avisos de Estoque</b></h3>
        </div>
        <div class="box-body">
            <div class="row">
                <div class="col-md-12">
                    <div class="callout callout-warning" style="margin-bottom:0px;">
                        <h4><i class="icon fa fa-ban"></i> Produtos com status - Atenção</h4>
                        Existem produto(s) com estoque em atenção <i class="fa fa-arrow-right"></i>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="callout callout-danger" style="margin-bottom:0px;">
                        <h4><i class="icon fa fa-ban"></i> Produtos com status - Abaixo</h4>
                        Existem produto(s) com estoque baixo <i class="fa fa-arrow-right"></i>
                        <a href="<?=BASE_URL?>estoque" class="small-box-footer">
                            Ir para estoque
                        </a>
                    </div>
    ...
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title"><i class="fa fa-warning"></i> <b>Avisos de Produto - Validade</b></h3>
        </div>
        <div class="box-body">
            <div class="row">
                <div class="col-md-12">
                    <div class="callout callout-info" style="margin-bottom:0px;">
                        <h4><i class="icon fa fa-ban"></i> Produtos com Validade próxima</h4>
                        Existem produto(s) com validade próxima <i class="fa fa-arrow-right"></i>
                        <a href="<?=BASE_URL?>estoque/validade" class="small-box-footer">
                            Ir para estoque
                        </a>
                    </div>
                </div>
