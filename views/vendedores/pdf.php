...
<body>
    <div class="container">
        ...
        <h5 class="text-center">Lista de Produtos <b> - <?= date('d/m/Y', strtotime($vendor_list['data_lista'])); ?></b>
        </h5><br>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <table class="table table-striped table-bordered">
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="0" class="text-left" style="font-size:14px;font-weight:bold;"><b>Total
                                    Produtos</b></td>
