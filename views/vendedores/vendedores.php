...
<!-- Main content -->
  ...
  <div class="box">
      <div class="box-body">
        <div class="row">
          <div class="col-md-4">
              <button class="btn btn bg-purple btn-flat"
                 data-toggle="modal" data-target="#modal-vendor">Cadastrar Vendedor
              </button>
          </div>
        </div>
      </div>
      ...
      <div class="box-body">
        <table class="table table-bordered table-striped dt-responsive tabela-res" width="100%">
            ...
            <?php foreach($list as $item): ?>
                ...
                <td>
                  <a href="<?=BASE_URL?>vendedores/edit/<?=$item['id_vendor']?>" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i> Editar</a>
                  <?php if($item['status'] == '0'): ?>
                    <a href="<?=BASE_URL?>vendedores/status/<?=$item['id_vendor']?>" class="btn btn-danger btn-xs"><i class="fa fa-times"></i> Inativo</a>
                  <?php else: ?>
                    <a href="<?=BASE_URL?>vendedores/status/<?=$item['id_vendor']?>" class="btn btn-success btn-xs"><i class="fa fa-check"></i> Ativo</a>
                  <?php endif; ?>  
                </td>
                </tr>
            <?php endforeach ?>
  ...
  <div class="modal fade" id="modal-vendor">
        ...
        <form action="<?php echo BASE_URL ?>vendedores/add" method="POST">
                <div class="row">
                  ...
                  <label>E-mail:</label>
                    <div class="input-group">
                      ...
                      <input type="email" class="form-control pull-right" name="email" id="" placeholder="Digite um E-mail">
                    </div>
                  </div>
                ...
                <div class="form-group col-md-4">
                  <label>Telefone:</label>
                    <div class="input-group">
                      ...
                      <input type="tel" class="form-control pull-right" id="tel" name="tel" placeholder="(00) 00000-0000">
                    </div>
                  </div>
                  ...
                  <label>CEP:</label>
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control pull-right" name="cep" id="cep" placeholder="00000-00">
                    </div>
                  </div>
                  <div class="form-group col-md-4">
                  <label>Rua:</label>
                  ...
                  <label>Comissão:</label>
                    <div class="input-group">
                      <div class="input-group-addon">
                        ...
                        <input type="number" class="form-control pull-right" name="comissao" placeholder="Ex. 30">
                    </div>
                  </div>
