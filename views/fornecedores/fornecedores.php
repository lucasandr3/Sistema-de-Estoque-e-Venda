              ...
              <div class="row">
                  <div class="col-md-10">
                      <button class="btn btn-app bg-default btn-touch" data-toggle="modal"
                          data-target="#modal-vendor"><i class="fa fa-plus-square"></i> Cadastrar Fornecedor
                      </button>
                      <a href="<?=BASE_URL?>fornecedores/inativos" class="btn btn-app bg-default btn-touch"><i
                              class="fa fa-times"></i> Fornecedores
                          Inativos
                      </a>
                  </div>
              </div>
