      ...
      <div class="row">
          <div class="col-md-12" style="color:#555;margin-bottom:-20px;">
              <ul class="breadcrumb">
                  ...
                  <li><a href="" style="color:#555;">Nova Marca</a></li>
              </ul>
          </div>
      </div>
  </section>
              ...
              <div class="row">
                  <div class="col-md-12">
                      <button class="btn btn-app bg-default" data-toggle="modal" data-target="#modal-vendor"><i
                              class="fa fa-cube"></i> Cadastrar Marca
                      </button>
          ...
          <div class="box-body">
              <table class="table table-bordered table-striped dt-responsive tabela-res" width="100%">
                  ...
                  <tbody>
                      ...
                      <tr>
                          <td class="text-capitalize"><?php echo $item['title'] ?></td>
                          <td>
                              <a href="<?=BASE_URL?>marcas/edit/<?=$item['id']?>" class="btn btn-primary btn-xs"><i
      ...
      <div class="modal-dialog">
          <div class="modal-content">
              <div class="modal-header" style="background-color:#2e4158;">
                  ...
                  <h4 class="modal-title text-center" style="color:white">Cadastro de Marca</h4>
              </div>
              <div class="modal-body">
                  <form action="<?php echo BASE_URL ?>marcas/add" method="POST">
                      <div class="row">
                          <div class="form-group col-md-12">
                              ...
                              <div class="input-group">
                                  ...
                                  <input type="text" class="form-control pull-right" name="title"
                                      placeholder="digite o nome da marca" autofocus>
                              </div>
                          </div>
                      </div>
