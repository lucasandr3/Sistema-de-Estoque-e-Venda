...
class Fornecedores extends Model
{
	...
	{
		$array = array();
		$sql ="SELECT * FROM fornecedores WHERE status = 0";
	...
	public function add($nome, $email, $tel, $cep, $rua, $bairro, $cidade, $estado, $numero, $status)
	{
		$sql ="INSERT INTO fornecedores SET nome = :nome, email = :email, tel = :tel, cep = :cep, rua = :rua,
	...
	public function toggleStatus($id_fornecedor)
	{
		$sql ="UPDATE fornecedores SET status = 1 - status WHERE id_fornecedor = '$id_fornecedor'";
		$sql = $this->db->query($sql);
